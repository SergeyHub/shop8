            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name"><strong>Product name:</strong>&nbsp{{$product->name}}</h2>
                        ...
                        <div class="wrap-price"><span class="product-price"></span><strong>Regular Prise $:</strong>&nbsp;{{$product->regular_price}}</div>
                        <div class="stock-info in-stock">
                            <p class="availability"><strong>Availability</strong>&nbsp;(Stock Status): <b>{{$product->stock_status}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
